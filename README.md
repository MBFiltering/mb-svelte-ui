...
See the "Typography" section of [STYLE-GUIDE.md](STYLE-GUIDE.md) for which faces ship and why.

## Style guide

[STYLE-GUIDE.md](STYLE-GUIDE.md) is the canonical house style for this package **and**
every app that consumes it: the palette and its semantics, light↔dark mappings, the `g2`
